# based on IMSToucan/Modules/ToucanTTS/dit_wrapper.py
...
from anonymization.modules.tts.toucan_codeswitching.CSdit import DiTConVBlock
...
class StyleAdaptiveLayerNorm(nn.Module):
    ...
    def forward(self, x, c):
        gamma, beta = torch.chunk(self.saln(c), chunks=2, dim=-1)
